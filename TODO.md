...
- Make all `block-ads` logic
- Make a bin to generate new certificates. Only use the utils functions and that should be all
- Make a whitelist to avoid TLS interception
